...
const blockMeta = [
	{ key: "block1", img: "https://images.pexels.com/photos/5905484/pexels-photo-5905484.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1", mediaPosition: "right" as const },
	{ key: "block2", img: "https://images.pexels.com/photos/12899112/pexels-photo-12899112.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1", mediaPosition: "left" as const },
	{ key: "block3", img: "https://images.pexels.com/photos/5324960/pexels-photo-5324960.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1", mediaPosition: "right" as const },
	{ key: "block4", img: "https://images.pexels.com/photos/5324969/pexels-photo-5324969.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1", mediaPosition: "left" as const },
] as const

const faqIndexes = [1, 2, 3, 4, 5] as const

export const ForIndependentSchoolsPage: NextPage = () => {
	const t = useTranslations("ForIndependentSchools")
				...
				media={{
					...
					mediaNode: (
						<div className="relative h-full w-full">
							{/* eslint-disable-next-line @next/next/no-img-element */}
							<img src="https://images.pexels.com/photos/7652188/pexels-photo-7652188.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt={t("cta.alt")} className="absolute inset-0 h-full w-full object-cover object-center" />
						</div>
					),
				}}
				mediaPosition="left"
