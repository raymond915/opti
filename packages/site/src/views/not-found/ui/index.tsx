	...
	return (
		<section className="contained-height nav-padding relative col-span-full grid w-full md:grid-cols-subgrid gap-gutter overflow-clip rounded-outer bg-mint-6">
			...
			<AudienceDirectorPanel
				className="absolute right-inner-padding bottom-inner-padding z-20 h-2/5 hidden md:block w-1/4"
				heading="Our audiences"
			/>
			<Logo
				className="absolute top-[10vh] right-[5vw] w-[80vw] md:w-[55vw] select-none opacity-[0.02]"
				logomark={true}
			/>
		</section>
	)
