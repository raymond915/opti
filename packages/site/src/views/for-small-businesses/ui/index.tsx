...
export const ForSmallBusinessesPage: NextPage = () => {
	const t = useTranslations("ForSmallBusinesses")
	...
	return (
		<>
			...
			<ContainedLayout className="grid grid-rows-1 bg-muted-1 p-0 md:p-0">
				<HighlightBlock
					background="white"
					body={t("highlights.block1.body")}
					buttonHref="/contact"
					buttonText={tShared("contactButton")}
					media={{
						type: "image",
						imageProps: {
							alt: t("highlights.block1.alt"),
					...
					media={{
						...
						mediaNode: (
							<div className="relative h-full w-full bg-mint-1">
								...
								<img src="https://images.pexels.com/photos/6457495/pexels-photo-6457495.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt={t("highlights.block2.alt")} className="absolute inset-0 h-full w-full object-cover" />
							</div>
						),
					}}
					mediaPosition="left"
				...
				<HighlightBlock
					...
					media={{
						...
						mediaNode: (
							<div className="relative h-full w-full bg-mint-1">
								{/* eslint-disable-next-line @next/next/no-img-element */}
								<img src="https://images.pexels.com/photos/4623080/pexels-photo-4623080.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt={t("highlights.block3.alt")} className="absolute inset-0 h-full w-full object-cover" />
							</div>
						),
					}}
					mediaPosition="right"
					title={t("highlights.block3.title")}
				>
					<HighlightBlockTitle />
					<HighlightBlockBody />
					<HighlightBlockButton />
				...
				media={{
					...
					mediaNode: (
						<div className="relative h-full w-full">
							{/* eslint-disable-next-line @next/next/no-img-element */}
							<img src="https://images.pexels.com/photos/5673489/pexels-photo-5673489.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt={t("cta.alt")} className="absolute inset-0 h-full w-full object-cover object-top" />
						</div>
					),
				}}
				mediaPosition="right"
